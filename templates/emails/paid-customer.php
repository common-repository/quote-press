<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php echo sprintf( __( 'Thank you for your order. This email confirms payment for Quote ID: %s via %s. You can view your quotes via your account.', 'quote-press' ), '{quote_id}', '{quote_payment_option}' ); ?></p>
