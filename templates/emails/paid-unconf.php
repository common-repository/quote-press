<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php echo sprintf( __( 'You have received an unconfirmed payment for Quote ID: %s via %s. Check for payment and mark the quote paid once the customer has instructed that they have made payment.', 'quote-press' ), '{quote_id}', '{quote_payment_option}' ); ?></p>
