<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php echo sprintf( __( 'You have received a new pending quote. Quote ID: %s.', 'quote-press' ), '{quote_id}' ); ?></p>
