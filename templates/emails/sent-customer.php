<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php echo sprintf( __( 'We have now reviewed your quote and it is available for you to review. Your Quote ID is: %s.', 'quote-press' ), '{quote_id}' ); ?></p>
