<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><?php echo sprintf( __( 'You have marked Quote ID: %s as sent. If customer notifications are enabled it will be sent to the customer. If disabled you should contact the customer and instruct them to review the quote via their account.', 'quote-press' ), '{quote_id}' ); ?></p>
